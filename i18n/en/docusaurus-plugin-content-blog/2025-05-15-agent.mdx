...
1. _An Overview of Agent-Oriented Programming_ — Y. Shoham, _Software Agents_, 1997
2. _The Landscape of Emerging AI Agent Architectures for Reasoning, Planning, and Tool Calling: A Survey_ — Tula Masterman, 2024
3. _Modelling Social Action for AI Agents_ — Cristiano Castelfranchi, 1998
4. _Deep Reinforcement Learning: An Overview_ — Yuxi Li, 2018
5. _Towards an Unsupervised Reward Function for a Deep Reinforcement Learning Based Intrusion Detection System_ — Bilel Saghrouchni et al., 2024
