...
_Comparison of posts on Stack Overflow, its Russian and Chinese equivalents, and
mathematics Q&A platforms since early 2022 [3]._

## Who Still Uses Stack Overflow?

As soon as ChatGPT was released, activity on Stack Overflow dropped sharply by 16%, and it has been getting worse ever since: in May 2022, there were over 200,000 questions asked on Stack Overflow; last October, there were only 11,116 questions, a 94% decrease in just over 3 years [4], unlike other equivalents or specialized platforms (see image above). We should therefore note several things: - LLMs are presumably good enough at code to answer the majority of questions asked on Stack Overflow about popular languages [3]. - More and more developers want a quick answer and prefer using LLMs to solve their problems, with all the risks that entails. - Fewer questions asked means less quality data for future LLM training.
