...
const items: Item[] = [
  ...
  {
    label: 'TensorFlow',
    src: '/img/stack/tensorflow.png',
    href: 'https://www.tensorflow.org/',
  },
  {
    label: 'Gymnasium',
    src: '/img/stack/gym.png',
    href: 'https://github.com/Farama-Foundation/Gymnasium',
  },
  {
    label: 'Stable-baseline3',
    src: '/img/stack/sb3.png',
    href: 'https://github.com/DLR-RM/stable-baselines3/',
  },
  {
    label: 'Scikit Learn',
    src: '/img/stack/sklearn.png',
    href: 'https://github.com/scikit-learn/scikit-learn',
  },
  {
    label: 'Langchain',
    src: '/img/stack/langchain.png',
    href: 'https://github.com/langchain-ai/langchain',
  },
  {
    label: 'Streamlit',
    src: '/img/stack/streamlit.png',
    href: 'https://github.com/streamlit/streamlit',
  },
  {
    label: 'ML-Flow',
    src: '/img/stack/mlflow.png',
    href: 'https://mlflow.org/',
  },
  {
    label: 'UV',
    src: '/img/stack/uv.svg',
    href: 'https://github.com/astral-sh/uv',
  },
  {
    label: 'pre-commit',
    src: '/img/stack/precommit.png',
    href: 'https://github.com/pre-commit/pre-commit',
  },
];
